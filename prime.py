def is_prime(num):
    ...
    if num > 1:
        ...
        for i in range(2, num):
            ...
            if (
                num % i
            ) == 0:  # If number is divisible by any number between 2 to num then its not prime
        ...
        if (
            prime
        ):  # Checking if the value of variable is True, if its True then its prime else not.SS
